...
--Cayo Perico--
	...
	CPC:add_int_range("Player 1", 0, 1, 999, function() return globals.get_int(1978495 + 825 + 56 + 1) end, function(CPc) globals.set_int(1978495 + 825 + 56 + 1, CPc) end) 
	CPC:add_int_range("Player 2", 0, 1, 999, function() return globals.get_int(1978495 + 825 + 56 + 2) end, function(CPc) globals.set_int(1978495 + 825 + 56 + 2, CPc) end) 
	CPC:add_int_range("Player 3", 0, 1, 999, function() return globals.get_int(1978495 + 825 + 56 + 3) end, function(CPc) globals.set_int(1978495 + 825 + 56 + 3, CPc) end) 
	CPC:add_int_range("Player 4", 0, 1, 999, function() return globals.get_int(1978495 + 825 + 56 + 4) end, function(CPc) globals.set_int(1978495 + 825 + 56 + 4, CPc) end) 					   
...
--Сasino--
	...
	DCC:add_int_range("Player 1", 0, 1, 999, function() return globals.get_int(1971696 + 2325 + 1) end, function(DCv7) globals.set_int(1971696 + 2325 + 1, DCv7) end) 
	DCC:add_int_range("Player 2", 0, 1, 999, function() return globals.get_int(1971696 + 2325 + 2) end, function(DCv7) globals.set_int(1971696 + 2325 + 2, DCv7) end) 
	DCC:add_int_range("Player 3", 0, 1, 999, function() return globals.get_int(1971696 + 2325 + 3) end, function(DCv7) globals.set_int(1971696 + 2325 + 3, DCv7) end) 
	DCC:add_int_range("Player 4", 0, 1, 999, function() return globals.get_int(1971696 + 2325 + 4) end, function(DCv7) globals.set_int(1971696 + 2325 + 4, DCv7) end) 
...
--Doomsday--
    ...
    DC:add_int_range("Player 1", 0, 1, 999, function() return globals.get_int(1967630 + 812 + 50 + 1) end, function(Dc) globals.set_int(1967630 + 812 + 50 + 1, Dc) end) 
	DC:add_int_range("Player 2", 0, 1, 999, function() return globals.get_int(1967630 + 812 + 50 + 2) end, function(Dc) globals.set_int(1967630 + 812 + 50 + 2, Dc) end) 
	DC:add_int_range("Player 3", 0, 1, 999, function() return globals.get_int(1967630 + 812 + 50 + 3) end, function(Dc) globals.set_int(1967630 + 812 + 50 + 3, Dc) end) 
	DC:add_int_range("Player 4", 0, 1, 999, function() return globals.get_int(1967630 + 812 + 50 + 4) end, function(Dc) globals.set_int(1967630 + 812 + 50 + 4, Dc) end)
