...
--Cayo Perico--
	...
	CPC:add_int_range("Player 1", 1, 1, 999, function() return globals.get_int(1978495 + 825 + 56 + 1) end, function(CPc) globals.set_int(1978495 + 825 + 56 + 1, CPc) end) 
	CPC:add_int_range("Player 2", 1, 1, 999, function() return globals.get_int(1978495 + 825 + 56 + 2) end, function(CPc) globals.set_int(1978495 + 825 + 56 + 2, CPc) end) 
	CPC:add_int_range("Player 3", 1, 1, 999, function() return globals.get_int(1978495 + 825 + 56 + 3) end, function(CPc) globals.set_int(1978495 + 825 + 56 + 3, CPc) end) 
	CPC:add_int_range("Player 4", 1, 1, 999, function() return globals.get_int(1978495 + 825 + 56 + 4) end, function(CPc) globals.set_int(1978495 + 825 + 56 + 4, CPc) end) 					   
...
--Сasino--
	...
	DCC:add_int_range("Player 1", 1, 1, 999, function() return globals.get_int(1971696 + 2325 + 1) end, function(DCv7) globals.set_int(1971696 + 2325 + 1, DCv7) end) 
	DCC:add_int_range("Player 2", 1, 1, 999, function() return globals.get_int(1971696 + 2325 + 2) end, function(DCv7) globals.set_int(1971696 + 2325 + 2, DCv7) end) 
	DCC:add_int_range("Player 3", 1, 1, 999, function() return globals.get_int(1971696 + 2325 + 3) end, function(DCv7) globals.set_int(1971696 + 2325 + 3, DCv7) end) 
	DCC:add_int_range("Player 4", 1, 1, 999, function() return globals.get_int(1971696 + 2325 + 4) end, function(DCv7) globals.set_int(1971696 + 2325 + 4, DCv7) end) 
...
--Doomsday--
	...
	DC:add_array_item("Presets", {"85 All", "100 All"}, function() return c2 end,
		function(Dp) if Dp == 1 then for i = 1963409, 1963412 do globals.set_int(i, 85) end
		elseif Dp == 2 then for i = 1963409, 1963412 do globals.set_int(i, 100) end end
		c2 = Dp end)
		
    DC:add_int_range("Player 1", 1, 1, 999, function() return globals.get_int(1963409) end, function(Dc) globals.set_int(1963409, Dc) end) 
	DC:add_int_range("Player 2", 1, 1, 999, function() return globals.get_int(1963410) end, function(Dc) globals.set_int(1963410, Dc) end) 
	DC:add_int_range("Player 3", 1, 1, 999, function() return globals.get_int(1963411) end, function(Dc) globals.set_int(1963411, Dc) end) 
	DC:add_int_range("Player 4", 1, 1, 999, function() return globals.get_int(1963412) end, function(Dc) globals.set_int(1963412, Dc) end)
